...
namespace BlackCat\Database\Packages\RbacSyncCursors;
...
use BlackCat\Database\Packages\RbacSyncCursors\Repository\RbacSyncCursorRepository as GeneratedRepository;
...
{
  private RbacSyncCursorRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof RbacSyncCursorRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected RbacSyncCursorRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RbacSyncCursors\Dto\RbacSyncCursorDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RbacSyncCursors\Dto\RbacSyncCursorDto|null { return $this->repo->getById($id, $asDto); }

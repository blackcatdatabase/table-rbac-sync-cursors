...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'rbac_sync_cursors'; }
    public static function contractView(): string { return 'vw_rbac_sync_cursors'; }
    /** @return string[] */
    public static function columns(): array { return [ 'repo_id', 'peer', 'last_commit', 'last_synced_at' ]; }
     ...
     * repo_id peer may be "id" or "col1, col2".
     * @return string[]
     */
    public static function pkColumns(): array {
        $raw = trim('repo_id peer');
        if ($raw === '') {
            throw new \InvalidArgumentException('Definitions::pkColumns(): token repo_id peer must not be empty.');
        }
    ...
    public static function defaultOrder(): ?string {
        $c = trim('repo_id peer DESC'); return $c !== '' ? $c : null;
    }

    /** @return array<int,array<int,string>> list of unique keys */
    public static function uniqueKeys(): array { return [ [ 'repo_id', 'peer' ] ]; }
    ...
    public static function intColumns(): array { return [ 'repo_id' ]; }

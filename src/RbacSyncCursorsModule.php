...
final class RbacSyncCursorsModule implements ModuleInterface
{
    public function name(): string { return 'table-rbac_sync_cursors'; }
    public function table(): string { return 'rbac_sync_cursors'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-rbac_repositories' ]; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedFk  = [ 'fk_rbac_cursors_repo' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [],
            'foreignKeys' => [ 'fk_rbac_cursors_repo' ],
        ];
    }
}

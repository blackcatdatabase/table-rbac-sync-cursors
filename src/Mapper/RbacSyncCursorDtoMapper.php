...
namespace BlackCat\Database\Packages\RbacSyncCursors\Mapper;

use BlackCat\Database\Packages\RbacSyncCursors\Dto\RbacSyncCursorDto;
use BlackCat\Database\Packages\RbacSyncCursors\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO RbacSyncCursorDto:
...
final class RbacSyncCursorDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'repo_id' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [];
    /** @var string[] */
    private const DATE_COLS   = [ 'last_synced_at' ];
    /** @var string[] */
     ...
     * @return RbacSyncCursorDto
     */
    public static function fromRow(array $row): RbacSyncCursorDto
    {
        /** @var RbacSyncCursorDto */
        return DtoHydrator::fromRow(
            RbacSyncCursorDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?RbacSyncCursorDto
    {
     ...
     *
     * @param RbacSyncCursorDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(RbacSyncCursorDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(RbacSyncCursorDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(RbacSyncCursorDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,RbacSyncCursorDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,RbacSyncCursorDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(RbacSyncCursorDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,RbacSyncCursorDto>
     */

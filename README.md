...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: todo · PII: none · Changelog: fresh (2 d)</div>
</div>
...
- Pkg folder: [packages\rbac-sync-cursors](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\rbac-sync-cursors)
...
graph LR
  ...
  rbac_sync_cursors["rbac_sync_cursors"]:::center
  rbac_sync_cursors -->|FK| rbac_repositories["rbac_repositories"]:::link
...
- Outbound (depends on): "rbac_repositories"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package rbac-sync-cursors -Apply

...
> Lineage: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: todo · PII flags: 0 · Changelog: fresh (0 d)
...
| Pkg folder | [packages\rbac-sync-cursors](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\rbac-sync-cursors) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package rbac-sync-cursors -Apply
